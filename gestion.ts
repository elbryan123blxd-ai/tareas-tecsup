// 1. Definimos la estructura exacta que debe tener cada usuario, como por ejemplo su nombre estado id etc
interface Usuario {
    id: number;
    nombre: string;
    estado: 'activo' | 'vencido'; // Solo permite estos dos valores
...
function filtrarUsuariosPorEstado(usuarios: Usuario[], estadoBuscado: 'activo' | 'vencido'): Usuario[] {
...
function obtenerAlertasDePago(usuarios: Usuario[]) {
